...
const webPageDefaultValues = process.env.NODE_ENV === 'development'
  ? {
      title: 'Sample Page',
      slug: 'sample-page',
...
const WebPageForm = ({
  ...
  const form = useForm<
    z.infer<typeof WebPageInputSchema> | z.infer<typeof WebPageUpdateSchema>
  >({
                ...
                <FormControl>
                  <div className='relative'>
                    ...
                    <button
                      ...
                      className='absolute right-2 top-2.5 text-xs underline'
                    >
                      Generate
                    </button>
                  </div>
